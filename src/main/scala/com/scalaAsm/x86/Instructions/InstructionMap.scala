...
object instructionMap {
  val instMap = Map[Int, Set[x86Instruction]](
    0 -> Set(ADD.ADD_0),
    1 -> Set(ADD.ADD_3, ADD.ADD_2, ADD.ADD_1),
    2 -> Set(ADD.ADD_4),
    3 -> Set(ADD.ADD_12, ADD.ADD_14, ADD.ADD_13),
    4 -> Set(ADD.ADD_15),
    5 -> Set(ADD.ADD_17, ADD.ADD_16),
    6 -> Set(PUSH.PUSH_3),
    7 -> Set(POP.POP_3),
    8 -> Set(OR.OR_0),
    9 -> Set(OR.OR_2, OR.OR_1, OR.OR_3),
    10 -> Set(OR.OR_4),
    11 -> Set(OR.OR_13, OR.OR_12, OR.OR_14, UD2.UD2_0),
    12 -> Set(OR.OR_15),
    13 -> Set(NOP.NOP_0, OR.OR_16, NOP.NOP_1, OR.OR_17),
    16 -> Set(ADC.ADC_0),
    17 -> Set(ADC.ADC_2, ADC.ADC_1, ADC.ADC_3),
    18 -> Set(ADC.ADC_4),
    19 -> Set(ADC.ADC_14, ADC.ADC_13, ADC.ADC_12),
    20 -> Set(ADC.ADC_15),
    21 -> Set(ADC.ADC_17, ADC.ADC_16),
    24 -> Set(HINT_NOP.HINT_NOP_1, SBB.SBB_0, HINT_NOP.HINT_NOP_0),
    25 -> Set(SBB.SBB_3, SBB.SBB_2, SBB.SBB_1),
    26 -> Set(SBB.SBB_4),
    27 -> Set(SBB.SBB_12, SBB.SBB_14, SBB.SBB_13),
    28 -> Set(SBB.SBB_15),
    29 -> Set(SBB.SBB_17, SBB.SBB_16),
    32 -> Set(AND.AND_0),
    33 -> Set(AND.AND_2, AND.AND_1, AND.AND_3),
    34 -> Set(AND.AND_4),
    35 -> Set(AND.AND_12, AND.AND_14, AND.AND_13),
    36 -> Set(AND.AND_15),
    37 -> Set(AND.AND_17, AND.AND_16),
    39 -> Set(DAA.DAA_0),
    40 -> Set(SUB.SUB_0),
    41 -> Set(SUB.SUB_3, SUB.SUB_2, SUB.SUB_1),
    42 -> Set(SUB.SUB_4),
    43 -> Set(SUB.SUB_13, SUB.SUB_12, SUB.SUB_14),
    44 -> Set(SUB.SUB_15),
    45 -> Set(SUB.SUB_17, SUB.SUB_16),
    47 -> Set(DAS.DAS_0),
    48 -> Set(XOR.XOR_0),
    49 -> Set(XOR.XOR_3, XOR.XOR_2, XOR.XOR_1),
    50 -> Set(XOR.XOR_4),
    51 -> Set(XOR.XOR_12, XOR.XOR_14, XOR.XOR_13),
    52 -> Set(XOR.XOR_15),
    53 -> Set(XOR.XOR_17, XOR.XOR_16),
    55 -> Set(AAA.AAA_0),
    56 -> Set(MOVBE.MOVBE_2, MOVBE.MOVBE_3, MOVBE.MOVBE_0, MOVBE.MOVBE_4, MOVBE.MOVBE_1, CMP.CMP_0, MOVBE.MOVBE_5),
    57 -> Set(CMP.CMP_2, CMP.CMP_1, CMP.CMP_3),
    58 -> Set(CMP.CMP_4),
    59 -> Set(CMP.CMP_12, CMP.CMP_14, CMP.CMP_13),
    60 -> Set(CMP.CMP_15),
    61 -> Set(CMP.CMP_17, CMP.CMP_16),
    63 -> Set(AAS.AAS_0),
    64 -> Set(CMOVO.CMOVO_2, INC.INC_5, CMOVO.CMOVO_0, CMOVO.CMOVO_1, INC.INC_4),
    ...
    72 -> Set(DEC.DEC_5, DEC.DEC_4, CMOVS.CMOVS_2, CMOVS.CMOVS_1, CMOVS.CMOVS_0),
    ...
    80 -> Set(PUSH.PUSH_6, PUSH.PUSH_5, PUSH.PUSH_4),
    88 -> Set(POP.POP_5, POP.POP_4, POP.POP_6),
    96 -> Set(PUSHAD.PUSHAD_0, PUSHA.PUSHA_0),
    97 -> Set(POPAD.POPAD_0, POPA.POPA_0),
    98 -> Set(BOUND.BOUND_1, BOUND.BOUND_0),
    99 -> Set(MOVSXD.MOVSXD_0, MOVSXD.MOVSXD_1),
    104 -> Set(PUSH.PUSH_7, PUSH.PUSH_8),
    106 -> Set(PUSH.PUSH_9),
    ...
    128 -> Set(JO.JO_2, AND.AND_5, CMP.CMP_5, XOR.XOR_5, OR.OR_5, SUB.SUB_5, ADC.ADC_5, ADD.ADD_5, JO.JO_1, SBB.SBB_5),
    129 -> Set(XOR.XOR_7, ADC.ADC_6, OR.OR_8, ADD.ADD_7, JNO.JNO_2, AND.AND_8, ADD.ADD_8, ADC.ADC_7, XOR.XOR_6, XOR.XOR_8, CMP.CMP_8, SBB.SBB_7, SUB.SUB_8, AND.AND_6, OR.OR_6, SUB.SUB_7, JNO.JNO_1, ADC.ADC_8, CMP.CMP_6, SBB.SBB_6, SBB.SBB_8, OR.OR_7, AND.AND_7, CMP.CMP_7, SUB.SUB_6, ADD.ADD_6),
    130 -> Set(JC.JC_1, JNAE.JNAE_2, JB.JB_1, JNAE.JNAE_1, JB.JB_2, JC.JC_2),
    131 -> Set(OR.OR_9, SBB.SBB_9, JNB.JNB_1, JAE.JAE_1, SUB.SUB_10, ADD.ADD_10, JNC.JNC_2, AND.AND_9, AND.AND_10, SBB.SBB_11, SUB.SUB_9, ADC.ADC_11, OR.OR_10, JNC.JNC_1, JNB.JNB_2, CMP.CMP_11, ADD.ADD_11, AND.AND_11, XOR.XOR_10, ADD.ADD_9, CMP.CMP_10, XOR.XOR_9, JAE.JAE_2, CMP.CMP_9, ADC.ADC_10, XOR.XOR_11, SUB.SUB_11, ADC.ADC_9, SBB.SBB_10, OR.OR_11),
    132 -> Set(JZ.JZ_1, JE.JE_2, JZ.JZ_2, JE.JE_1, TEST.TEST_0),
    133 -> Set(TEST.TEST_1, TEST.TEST_3, JNZ.JNZ_2, JNZ.JNZ_1, TEST.TEST_2, JNE.JNE_1, JNE.JNE_2),
    134 -> Set(JNA.JNA_2, XCHG.XCHG_0, JBE.JBE_1, JNA.JNA_1, JBE.JBE_2),
    135 -> Set(JA.JA_1, JNBE.JNBE_1, JNBE.JNBE_2, XCHG.XCHG_2, XCHG.XCHG_3, JA.JA_2, XCHG.XCHG_1),
    136 -> Set(JS.JS_2, JS.JS_1, MOV.MOV_0),
    137 -> Set(MOV.MOV_2, JNS.JNS_2, MOV.MOV_1, JNS.JNS_1, MOV.MOV_3),
    138 -> Set(JPE.JPE_1, JP.JP_2, JPE.JPE_2, JP.JP_1, MOV.MOV_4),
    139 -> Set(MOV.MOV_11, JNP.JNP_2, JPO.JPO_1, JPO.JPO_2, JNP.JNP_1, MOV.MOV_10, MOV.MOV_12),
    140 -> Set(JL.JL_1, MOV.MOV_14, MOV.MOV_15, MOV.MOV_16, JL.JL_2, MOV.MOV_13, JNGE.JNGE_1, JNGE.JNGE_2),
    141 -> Set(LEA.LEA_0, JGE.JGE_1, LEA.LEA_1, JNL.JNL_1, LEA.LEA_2, JNL.JNL_2, JGE.JGE_2),
    142 -> Set(MOV.MOV_5, JNG.JNG_1, JLE.JLE_1, JNG.JNG_2, JLE.JLE_2),
    143 -> Set(POP.POP_1, JG.JG_1, JG.JG_2, JNLE.JNLE_2, POP.POP_2, JNLE.JNLE_1, POP.POP_0),
    144 -> Set(XCHG.XCHG_6, NOP.NOP_2, XCHG.XCHG_4, SETO.SETO_0, XCHG.XCHG_5),
    ...
    160 -> Set(MOV.MOV_17),
    161 -> Set(MOV.MOV_20, MOV.MOV_19, MOV.MOV_18),
    162 -> Set(CPUID.CPUID_0),
    163 -> Set(BT.BT_0, BT.BT_2, BT.BT_1),
    ...
    168 -> Set(TEST.TEST_8),
    169 -> Set(TEST.TEST_10, TEST.TEST_9),
    170 -> Set(STOS.STOS_0, STOSB.STOSB_0),
    171 -> Set(BTS.BTS_0, STOSW.STOSW_0, STOSQ.STOSQ_0, BTS.BTS_1, BTS.BTS_2, STOSD.STOSD_0),
    172 -> Set(LODS.LODS_0, LODSB.LODSB_0),
    173 -> Set(SHRD.SHRD_2, SHRD.SHRD_1, LODSQ.LODSQ_0, SHRD.SHRD_0, LODSW.LODSW_0, LODSD.LODSD_0),
    174 -> Set(SCASB.SCASB_0, SCAS.SCAS_0),
    175 -> Set(IMUL.IMUL_5, SCASQ.SCASQ_0, IMUL.IMUL_6, SCASW.SCASW_0, IMUL.IMUL_4, SCASD.SCASD_0),
    176 -> Set(CMPXCHG.CMPXCHG_0, MOV.MOV_21),
    177 -> Set(CMPXCHG.CMPXCHG_3, CMPXCHG.CMPXCHG_2, CMPXCHG.CMPXCHG_1),
    178 -> Set(LSS.LSS_1, LSS.LSS_0, LSS.LSS_2),
    179 -> Set(BTR.BTR_1, BTR.BTR_0, BTR.BTR_2),
    180 -> Set(LFS.LFS_0, LFS.LFS_2, LFS.LFS_1),
    181 -> Set(LGS.LGS_1, LGS.LGS_0, LGS.LGS_2),
    182 -> Set(MOVZX.MOVZX_1, MOVZX.MOVZX_0, MOVZX.MOVZX_2),
    183 -> Set(MOVZX.MOVZX_4, MOVZX.MOVZX_3, MOVZX.MOVZX_5),
    184 -> Set(MOV.MOV_22, POPCNT.POPCNT_1, MOV.MOV_23, POPCNT.POPCNT_2, POPCNT.POPCNT_0, MOV.MOV_24),
    186 -> Set(BT.BT_5, BTC.BTC_2, BTR.BTR_4, BTS.BTS_4, BTC.BTC_1, BTR.BTR_5, BT.BT_3, BTC.BTC_0, BT.BT_4, BTS.BTS_5, BTR.BTR_3, BTS.BTS_3),
    187 -> Set(BTC.BTC_3, BTC.BTC_5, BTC.BTC_4),
    188 -> Set(BSF.BSF_2, BSF.BSF_1, BSF.BSF_0),
    189 -> Set(BSR.BSR_0, BSR.BSR_2, BSR.BSR_1),
    190 -> Set(MOVSX.MOVSX_0, MOVSX.MOVSX_2, MOVSX.MOVSX_1),
    191 -> Set(MOVSX.MOVSX_3, MOVSX.MOVSX_5, MOVSX.MOVSX_4),
    192 -> Set(SAL.SAL_0, ROL.ROL_0, ROR.ROR_0, SAR.SAR_0, XADD.XADD_0, SHL.SHL_0, RCL.RCL_0, RCR.RCR_0, SHR.SHR_0),
    193 -> Set(ROR.ROR_1, SAR.SAR_2, ROL.ROL_2, RCL.RCL_3, RCR.RCR_3, XADD.XADD_2, RCR.RCR_2, SHL.SHL_1, SAL.SAL_2, SHR.SHR_3, SAR.SAR_1, SHL.SHL_2, SAR.SAR_3, SAL.SAL_3, SHR.SHR_2, SHR.SHR_1, XADD.XADD_1, RCL.RCL_1, SAL.SAL_1, SHL.SHL_3, ROR.ROR_2, XADD.XADD_3, RCL.RCL_2, ROL.ROL_1, ROR.ROR_3, ROL.ROL_3, RCR.RCR_1),
    194 -> Set(RETN.RETN_0),
    195 -> Set(RETN.RETN_1),
    196 -> Set(LES.LES_1, LES.LES_0),
    197 -> Set(LDS.LDS_1, LDS.LDS_0),
    198 -> Set(MOV.MOV_6),
    199 -> Set(CMPXCHG8B.CMPXCHG8B_0, CMPXCHG16B.CMPXCHG16B_0, MOV.MOV_7, MOV.MOV_8, MOV.MOV_9),
    ...
    208 -> Set(RCR.RCR_4, SHL.SHL_4, ROR.ROR_4, RCL.RCL_4, SAR.SAR_4, ROL.ROL_4, SHR.SHR_4, SAL.SAL_4),
    209 -> Set(SHR.SHR_5, RCL.RCL_7, ROR.ROR_7, SAR.SAR_6, SAR.SAR_5, SAL.SAL_5, ROL.ROL_6, SHL.SHL_6, SHL.SHL_5, ROL.ROL_5, SAR.SAR_7, SAL.SAL_6, SHL.SHL_7, ROR.ROR_5, RCL.RCL_5, RCR.RCR_7, SAL.SAL_7, SHR.SHR_6, RCR.RCR_5, ROR.ROR_6, RCL.RCL_6, ROL.ROL_7, RCR.RCR_6, SHR.SHR_7),
    ...
    247 -> Set(IDIV.IDIV_2, NEG.NEG_3, NOT.NOT_1, MUL.MUL_1, MUL.MUL_2, IDIV.IDIV_3, IMUL.IMUL_2, DIV.DIV_3, NEG.NEG_2, TEST.TEST_7, NOT.NOT_3, DIV.DIV_2, IMUL.IMUL_3, TEST.TEST_6, MUL.MUL_3, NEG.NEG_1, IDIV.IDIV_1, DIV.DIV_1, TEST.TEST_5, NOT.NOT_2, IMUL.IMUL_1),
    248 -> Set(CLC.CLC_0),
    249 -> Set(STC.STC_0),
    250 -> Set(CLI.CLI_0),
    251 -> Set(STI.STI_0),
    ...
    255 -> Set(INC.INC_1, JMP.JMP_0, DEC.DEC_1, INC.INC_2, DEC.DEC_3, CALL.CALL_2, JMP.JMP_1, PUSH.PUSH_1, INC.INC_3, PUSH.PUSH_2, PUSH.PUSH_0, CALL.CALL_1, JMP.JMP_2, DEC.DEC_2, CALL.CALL_0))
}
